...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'tc_calculator_dialog_base.ui'))
    ...
    def validate_inputs(self):
        ...
        try:
            ...
            if basin_crs.authid() != "EPSG:3361":
                self.progress_updated.emit(
                    0, f"Warning: Not using target CRS EPSG:3361 (using {basin_crs.authid()})"
                )
...
class TCCalculatorDialog(QDialog, FORM_CLASS):

    def __init__(self, parent=None):
        """Constructor."""
        super(TCCalculatorDialog, self).__init__(parent)
        ...
        # Setup the dialog manually since we need to create custom UI
        self.setup_custom_ui()
        self.populate_layers()

    def setup_custom_ui(self):
        """Setup the custom user interface"""
        ...
        title = QLabel("Time of Concentration Calculator - Version 6.0.0")
